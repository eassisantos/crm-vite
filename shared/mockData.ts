...
export const initialCaseStatuses: CaseStatus[] = [
  'Aberto',
  'Em Andamento',
  'Pendente',
  'Fechado',
...
export const mockCases: Case[] = [
  {
    ...
    notes:
      'Cliente completou 65 anos. Possui 185 contribuições no CNIS. Necessário verificar períodos de trabalho rural não averbados.',
    aiSummary: '',
    tasks: [
  ...
  },
  {
    ...
    notes:
      'Perícia inicial negou o benefício. INSS emitiu carta de exigência solicitando laudo de especialista em ortopedia.',
    aiSummary: '',
    tasks: [
...
export const mockFees: Fee[] = [
  ...
  { id: 'f2', caseId: '2', description: 'Honorários de Êxito', amount: 8000, dueDate: '2025-01-15', type: FeeType.EXITO, status: FeeStatus.PENDENTE },
  {
    id: 'f3',
    caseId: '1',
    description: 'Parcelamento Contratual',
    amount: 3000,
    dueDate: '2024-12-30',
    type: FeeType.PARCELADO,
    status: FeeStatus.PARCIALMENTE_PAGO,
    installments: [
...
export const mockExpenses: Expense[] = [
  { id: 'e1', caseId: '1', description: 'Custas de cópias', amount: 45.5, date: '2024-07-21' },
...
export const mockDocumentTemplates: DocumentTemplate[] = [
  ...
  },
  {
    ...
    content:
      'DECLARAÇÃO DE HIPOSSUFICIÊNCIA\n\nEu, {{cliente.name}}, portador(a) do CPF nº {{cliente.cpf}}, declaro para os devidos fins, sob as penas da lei, que não possuo condições financeiras de arcar com as custas processuais e honorários advocatícios sem prejuízo do meu sustento e de minha família...',
    headerImage: '',
    footerImage: '',
    backgroundImage: '',
  },
